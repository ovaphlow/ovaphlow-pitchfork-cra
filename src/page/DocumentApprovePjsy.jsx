    ...
    <Layout option="一体化作业">
      ...
      <Box>
        <div className="grid gap-4">
          <BoxSelect text="班组" value={pbz} onChange={(e) => setPbz(e.target.value)} option={["无"].concat(pbzList)} />
          <BoxSelect text="质检" value={qc} onChange={(e) => setQc(e.target.value)} option={["无"].concat(qcList)} />
